...
// import { JoinChannelDto, CreateChannelDto, PublicChannelDto } from '../dto/channel.dto';
...
//       }
//    }
//    async newPublicChannel(channelInfo: PublicChannelDto, user: User): Promise<Channel> {
//       try   {
//          const tmpchan: CreateChannelDto = {
//             name: channelInfo.name,
//             private: false,

//          }
//          const channel = await this.channelService.createChannel(tmpchan, user);
//          try   {
//             user.channels = [];
//             user.channels.push(channel);
//             console.log(await this.userService.saveUser(user));
//             //TODO maybe check if found dunno 🤷‍♂️

//             // const socketId = (await this.chatUserService.findByUser(user)).socketId;
//             const chater = await this.chatUserService.findByUser(user);
//             const socketId = chater.socketId;
//             await this.joinedChannelService.create(user, socketId, channel);
//             return channel;
//          }  catch (error)  {
//             Logger.error(error);           
//             //TODO delete channel
