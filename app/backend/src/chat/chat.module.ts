...
@Module({
  imports: [UserModule, TypeOrmModule.forFeature([Channel, ChatUser, Message, JoinedChannel, Mute])],
  providers: [ChannelService, ChatGateway, MessageService, ChatUserService, JoinedChannelService, MuteService],
})
